  ...
  for (var y = 0; y < this.height; y++) {
    ...
    for (var x = 0; x < this.width; x++) {
      ...
      // Because there is a third case (space ' '), use an "else if" instead of "else"
        ...
        else if (ch == "H")// level one hazard portal
        fieldType = "hazard";

        else if  (ch == "A") // level 2 hazard portal
        fieldType ="hazard2";

        else if  (ch == "R")// level 3 hazard portal
        fieldType ="hazard3";

        else if  (ch == "Z")// level 4 hazard portl
        fieldType ="hazard4";

        else if (ch == "T") // transfer portal level 2
        fieldType = "transfer";

        else if (ch == "U")
        fieldType = "transfer2"; //transfer portal level 3

        else if (ch == "J")
        fieldType = "transfer3";//transfer portal level 4

        else if (ch =="K")
        fieldType = "transfer4";//transfer portal level4
...
Level.prototype.playerTouched = function(type, actor) {
  ...
  else if (type == "Aportal"){
    this.player.pos = new Vector(45,2); // first level portal
  }
   if (type == "Bportal"){
    this.player.pos = new Vector(80,20);//first level portal
  }
  else if (type == "Cportal"){ //second level portal
this.player.pos = new Vector(12,12);
  }
 if (type == "Dportal"){// second level portal
  this.player.pos = new Vector(10,10);
 }
 else if (type == "Eportal"){ // third level portal
   this.player.pos =new Vector(11,11)
 }
 else if (type == "Fportal") {// third level portal
   this.player.pos =vnew Vector(10,10);
  }
  else if (type =="Gportal") { // fourth level portal
    this.player.pos = new Vector(10,10);

  }
  else if (type =="Hportal") {// forth level portal
    this.player.pos =new Vector (10,10);
  }
  else if (type =="hazard") {// HAZARD
    this.player.pos = new Vector (10,10);
  }
  else if (type =="hazard2") {// HAZARD
    this.player.pos = new Vector (10,10);
  }
  else if (type =="hazard3") {// hazard
    this.player.pos = new Vector (10,10);
  }
  else if (type =="hazard4") {// HAZARD
    this.player.pos = new Vector (10,10);
  }
  else if (type == "transfer"){ //level 2 trnasfer portal
  this.player.pos new Vector(10,10);
}
else if (type == "transfer2"){ //transfer2 level 2
this.player.pos new Vector(10,10);
}
else if (type == "transfer3"){ //transfer portal level 3
this.player.pos new Vector(10,10);
}
else if (type == "transfer4"){ //transfer level 4
this.player.pos new Vector(10,10);
}
else if (type== "transfer5"){
  this.player.pos = new Vector(10,10);
}
};
